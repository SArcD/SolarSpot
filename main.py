...
def main():
    ...
    #########
        ...
        coordinates = [
            (-11.7, -38.0), (-8.4, -0.6), (-12.3, -15.6), (-20.2, -59.5), (-30.8, -2.5),
            (-43.4, -19.0), (-57.6, -45.9), (-13.0, -21.1), (30.6, -3.0), (-13.2, -50.5),
            (-55.1, -42.8), (-36.4, -39.1), (-17.0, -39.0), (-57.2, -42.0), (-36.8, -47.8),
            (-16.0, -56.0), (-54.8, -6.4), (-33.3, -18.7), (-11.4, -32.8), (-49.2, -48.5),
            (-26.8, -5.7), (-4.0, -24.2), (-41.1, -43.8), (-17.9, -4.6), (-54.4, -26.3),
            (-30.8, -49.0), (-7.0, -12.4), (-43.0, -36.6), (-18.9, -1.4), (-54.6, -26.8),
            (-30.1, -52.8), (-5.5, -19.2), (-40.8, -46.0), (-15.9, -13.3), (-51.0, -40.8),
            (-25.9, -8.6), (-0.7, -36.6), (-35.4, -4.8), (-10.1, -33.1), (-44.6, -1.5),
            (-19.1, -29.9), (-53.5, -58.4), (-27.8, -26.8), (-2.0, -55.1), (-36.2, -23.3),
            (-10.3, -51.4), (-44.4, -19.2), (-18.4, -46.8), (-52.3, -14.2), (-26.3, -41.2),
            (-0.1, -7.8), (-33.9, -34.0), (-7.7, -59.8), (-41.4, -25.1), (-15.1, -49.8),
            (-48.8, -13.9), (-22.4, -37.4), (-56.0, -0.1), (-29.6, -22.1), (-3.1, -43.3),
            (-36.6, -3.6), (-10.0, -23.0), (-43.4, -41.3), (-16.8, -58.5), (-50.1, -14.6),
            (-23.4, -29.5), (-56.6, -43.0), (-29.8, -55.0), (-2.9, -5.6), (-36.0, -14.5),
            (-9.0, -21.6), (-41.9, -26.9), (-14.7, -30.1), (-47.4, -31.1), (-19.9, -29.8),
            (-52.4, -26.0), (-24.7, -19.4), (-56.8, -9.9), (-28.7, -57.1), (-0.4, -40.9),
            (-31.8, -20.8), (-2.9, -56.5), (-33.7, -27.6), (-4.0, -53.5), (-33.8, -13.8),
            (-3.0, -27.7), (-31.6, -34.4), (-59.3, -32.8), (-26.0, -21.8), (-51.5, -59.6),
            (-15.4, -24.0), (-37.4, -32.1), (-56.9, -19.4), (-12.7, -38.8), (-23.3, -17.7),
            (-24.7, -48.5)
        ]

        # Agregar las coordenadas al mapa
        for coord in coordinates:
            folium.Marker([coord[0], coord[1]]).add_to(mexico_map)
